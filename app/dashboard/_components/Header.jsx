    ...
    <div className="bg-white/80 shadow-sm ">
      <div className="w-[80%] m-auto flex gap-4 items-center justify-between">
        ...
        <motion.h1 
              ...
              className="text-3xl font-bold text-indigo-700 h-20 pt-5"
            >
              NxtMock
            </motion.h1>
        </Link>
        <ul className="hidden md:flex gap-6">
          <Link href="/dashboard">
            <li
              className={`text-indigo-700 hover:text-indigo-700 hover:font-bold transition-all cursor-pointer ${
          ...
          <li
            className={`text-indigo-700 hover:text-indigo-700 hover:font-bold transition-all cursor-pointer ${
              path == "/dashboard/question" && "text-indigo-700 font-bold"
            }`}
          >
            Questions
          </li>
          ...
          <Link href="/dashboard/howit">
            <li
              className={`text-indigo-700 hover:text-indigo-700 hover:font-bold transition-all cursor-pointer ${
                path == "/dashboard/howit" && "text-indigo-700 font-bold"
              }`}
            >
              How it works?
            </li>
